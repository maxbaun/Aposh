...
function theme_settings_page(){
  if (isset($_POST["update_settings"])) {
    ...
    $aposh_images_per_page = esc_attr($_POST["aposh_images_per_page"]);
    update_option("aposh_images_per_page", $aposh_images_per_page);
    ...
    $aposh_images_per_page = get_option("aposh_images_per_page");
    ...
    <form method="POST" action="">
     <table class="form-table">
      ...
      <table class="form-table">
        ...
        <tr valign="top">
          <th scope="row">
            <label for="aposh_images_per_page">
              Images Per Page:
            </label>
          </th>
          <td>
            <input type="text" name="aposh_images_per_page" id="aposh_images_per_page" value="<?php echo $aposh_images_per_page;?>"/>
          </td>
        </tr>
      </table>
